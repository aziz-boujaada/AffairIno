          ...
          >
            ...
            <div className="absolute inset-0 bg-zinc-900 group">
              ...
              <div className="absolute right-4 bottom-24 flex flex-col items-center gap-6 z-20 pointer-events-auto">
                ...
                >
                  <div className={`p-3 rounded-full backdrop-blur-sm transition-all ${hasLiked ? 'bg-red-500/20 text-red-500' : 'bg-white/10 text-white group-hover/btn:bg-white/20'}`}>
              ...
              <div className="absolute left-4 right-20 bottom-8 z-20 pointer-events-auto">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-full bg-accent overflow-hidden border border-white/20">
                    <img src="https://res.cloudinary.com/dzketg5uv/image/upload/f_auto,q_auto/AFFAIRINO_LOGO_pgvlii" className="w-full h-full object-cover" alt="Avatar" />
                  </div>
                  <span className="text-white font-bold text-sm tracking-wide">affairino_hq</span>
                ...
                <p className="text-white/90 text-sm line-clamp-2 leading-relaxed">
                  L'impact est une affaire de stratégie et de vision. Découvrez comment nous accompagnons les leaders 🚀📈
                </p>
